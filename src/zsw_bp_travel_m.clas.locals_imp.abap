CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE ZSW_I_Travel_M.
...
**********************************************************************
  METHOD validate_dates.
    ...
    READ ENTITY ZSW_I_Travel_M\\travel FIELDS ( begin_date end_date )  WITH
...
**********************************************************************
  METHOD validate_travel_status.
    ...
    READ ENTITY ZSW_I_Travel_M\\travel FIELDS ( overall_status ) WITH
        VALUE #( FOR <root_key> IN keys ( %key = <root_key> ) )
        RESULT DATA(lt_travel_result).
