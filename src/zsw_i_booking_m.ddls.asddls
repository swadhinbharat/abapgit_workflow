@AbapCatalog.sqlViewName: 'ZSW_IBOOKING_M'
...
define view ZSW_I_BOOKING_M
  as select from /dmo/booking_m as Booking

  association        to parent ZSW_I_Travel_M as _Travel     on  $projection.travel_id = _Travel.travel_id
  composition [0..*] of ZSW_I_BookSuppl_M     as _BookSupplement
